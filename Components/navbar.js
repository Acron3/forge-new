...
import LogoTeks from '../public/images/tulisan.png'
                ...
                <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                    ...
                    <div className="flex-1 flex items-center md:justify-between sm:items-stretch justify-center">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">GOVERNANCE</a>

                            <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">COMMUNITY</a>
                        </div>
                        </div>
                    </div>
                    </div>
